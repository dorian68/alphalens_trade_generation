...
from alphalens_forecast.regime_detection.deterministic import DeterministicRegimeDetector
...
def main() -> None:
    ...
    _plot_regime_series(df, series, f"{symbol} ({timeframe}) regime detection")
